...
void page_fault(pt_regs *regs)
{
    ...
    print("Page fault! ( ", 0, RED_TXT);
    if (present) {print("present ", 0, RED_TXT);}
    if (rw) {print("read-only ", 0, RED_TXT);}
    if (us) {print("user-mode ", 0, RED_TXT);}
    if (reserved) {print("reserved ", 0, RED_TXT);}
    print(") at 0x", 0, RED_TXT);
    printk("%x", faulting_address);
    print(" - EIP: ", 0, RED_TXT);
    printk("%x", regs->eip);
    print("\n", 0, RED_TXT);
    PANIC("Page fault");
