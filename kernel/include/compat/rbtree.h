/* kernel/include/compat/rbtree.h — kernel's own copy of libc/rbtree.h.
 *
 * Phase 2 #5 R2. FROZEN — see compat/list.h header.
 */

#ifndef _KERNEL_COMPAT_RBTREE_H
#define _KERNEL_COMPAT_RBTREE_H
