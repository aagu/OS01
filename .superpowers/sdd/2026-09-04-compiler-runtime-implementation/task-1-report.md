...
- `runtime/tests/udivti3_vectors.h`: 132 literal vectors (4 required edge vectors plus 128 pseudo-random cases), generated with `random.Random(0x0A501D17)`; quotient limbs are checked-in values.
